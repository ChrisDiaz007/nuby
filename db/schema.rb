...
ActiveRecord::Schema[7.1].define(version: 2026_03_31_150442) do
  ...
  create_table "calorie_profiles", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_calorie_profiles_on_user_id", unique: true
  end
  ...
  add_foreign_key "calorie_profiles", "users"
